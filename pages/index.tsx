    ...
    return (
      <>
        <style jsx global>
          {`
      body {
        background-image: url('betsbg6.png') !important;
            ...
            <Flex minWidth='max-content' alignItems='center' gap='2'>
              ...
              {loading ? (<></>) : (
                <Flex justifyContent="flex-end" marginLeft="auto">
                  <Box background={"#03ff00"} borderRadius={"8px"} minWidth={"50px"} minHeight={"50px"} p={2}>
                    <VStack>
                      <Text fontSize={"sm"} color={"black"}>Available NFTs:</Text>
                      <Text fontWeight={"semibold"} color={"black"}>{Number(candyMachine?.data.itemsAvailable) - Number(candyMachine?.itemsRedeemed)}/{Number(candyMachine?.data.itemsAvailable)}</Text>
                    </VStack>
                  </Box>
                </Flex>
              )}
